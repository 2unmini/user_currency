...
public interface CurrencyExchangeRepository extends JpaRepository<CurrencyExchange,Long> {
    ...
    @Query(value = "select new com.sparta.currency_user.dto.currency.TotalUserCurrencyResponseDto(count(c.user.id),sum(c.preExchangeAmount)) from CurrencyExchange c WHERE c.user.id=:userId and c.status=:NOMAL")
